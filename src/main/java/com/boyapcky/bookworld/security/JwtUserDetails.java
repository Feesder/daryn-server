...
public class JwtUserDetails implements UserDetails {
    ...
    public static JwtUserDetails toModel(UserEntity userEntity) {
        return new JwtUserDetails(
                ...
                mapToGrantedAuthority(new ArrayList<>(userEntity.getRoles()))
        );
    }

    private static List<GrantedAuthority> mapToGrantedAuthority(List<RoleEntity> roles) {
        return roles.stream()
                .map(role ->
