...
public class LoginResponse {
    ...
    public LoginResponse(Long id, String username, String email, List<Role> roles, String refreshToken, String accessToken) {
        this.id = id;
    ...
    public static LoginResponse toModel(UserEntity userEntity, String refreshToken, String accessToken) {
